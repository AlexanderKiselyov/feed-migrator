...
public class Help extends Command {
    private static final String HELP = """
            ...
            2. В каналах с подключенным ботом авто-постинга запрещается публиковать контент, нарущающий\s"""
            + """
            законодательство РФ (ненормативная лексика, контент 18+ и др.). Вся ответственность за распространение\s"""
            + """ 
            такого контента возлагается на лицо, опубликовавшее контент в Телеграм-канале с подключенным ботом"""
            + """
             авто-постинга.
            ...
            5. Публикация из закрытых Телеграм-каналов, а также публикация в закрытые группы социальных сетей не\s"""
            + """
