...
public abstract class PostingHelper {
    ...
    public abstract static class Post {
        ...
        public abstract Post addPhotos(List<PhotoSize> photos) throws URISyntaxException, IOException, TelegramApiException;

        public abstract Post addVideos(List<Video> videos) throws URISyntaxException, IOException, TelegramApiException;

        public abstract Post addText(String text);

        public abstract Post addPoll(Poll poll);

        public abstract Post addAnimations(List<Animation> animations) throws URISyntaxException, IOException, TelegramApiException;

        public abstract Post addDocuments(List<Document> documents);

        public abstract void post(String accessToken, long groupId) throws URISyntaxException, IOException;
    }
}
