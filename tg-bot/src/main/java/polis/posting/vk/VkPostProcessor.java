...
public class VkPostProcessor extends PostProcessor {
    ...
    private static final String DOCUMENT_WARNING = """
            ...
            2.2. Откройте доступ к разделу 'Файлы' - либо сделайте его открытым для все пользователей, либо ограниченным и доступным только для администраторов и редакторов сообщества""";
